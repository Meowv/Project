...
var GetTaskSystem = function(obj){
    if(!_cache.TaskSystem){
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;bottom:30px;display:none"><ul><li><a menu="close" href="http://tangdong.qzone.qq.com" target="_blank">云豆空间</a></li><li><a menu="close" href="http://wpa.qq.com/msgrd?v=3&uin=864524951&site=qq&menu=yes" target="_blank">联系云豆</a></li></ul></div>');
